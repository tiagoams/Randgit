...
```{r}
library(xlsx)
sportlog=read.xlsx("c:/Users/tams00/Documents/casa/Sport_2018.xlsx",sheetName="2018")
```
...
ggplot(data=week.dist,aes(x=date, y=dist,group = 1))+
  geom_line(color="magenta")+
  geom_point(data=runevents, aes(x=Date, y=Dist..mi.))+
  geom_smooth(data=runevents,  aes(x=Date, y=Dist..mi.),color = "blue")
